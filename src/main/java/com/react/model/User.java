...
public class User {
	...
	public User(Integer id, String username, String name, String email, String password, String mobile, String website,
			String bio, String gender, String image, Set<UserDto> follower, Set<UserDto> following, List<Story> stories,
